...
public abstract class Person {
    ...
    public void assignPet(Animal pet) {
        ...
        if (this.pet != null){
            throw new IllegalStateException("Person already has a pet");
        }

        if (!canHavePet(pet)){
            throw new IllegalArgumentException("This person cannot own this type of pet");
        }
    ...
    public void leavePetWith(Person caretaker) {
        if (!hasPet()){
            throw new IllegalStateException("No pet to leave");
        }
